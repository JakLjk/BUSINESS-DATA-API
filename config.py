...
KRS_API_URL = os.getenv("KRS_API_URL")
AUTOMATION_REFRESH_INTERVAL_HOURS = int(os.getenv("REFRESH_INTERVAL_HOURS", 24))
AUTOMATION_NUM_OF_DAYS_TO_CHECK = int(os.getenv("NUM_OF_DAYS_TO_CHECK",1))